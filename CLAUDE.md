...
- `agent-department/[Dept]/[agent]/MEMORY.md` — when assigned by Marcus (agent switch Rule 1)
...
|---|---|---|
| Executive summary, CEO brief, priorities, OKRs, business direction, synthesis, strategy, War Room | 👑 Marcus | `agent-department/CEO/marcus/MEMORY.md` |
| Operations, workflow, process, project plan, milestones, sprint planning, dependencies | ⚙️ Diana | `agent-department/COO/diana/MEMORY.md` |

### Layer 2 — BUILD (Everything That Ships)

| Task Keywords | Agent | Read This File |
|---|---|---|
| Next.js, API routes, architecture, tech decision, build error, TypeScript, Vercel, deployment | 💻 Dev | `agent-department/Technical/dev/MEMORY.md` |
| Supabase, database, query, backend API, data model, route.ts, schema, migration | 🔧 Raj | `agent-department/Technical/raj/MEMORY.md` |
| React component, UI, Tailwind, layout, CSS, design system, wireframe, UX, screen design, visual design | 🎨 Mia | `agent-department/Technical/mia/MEMORY.md` |
| Testing, bug, QA review, lint, build check, edge case, verification, code quality, Pulse | 🧪 Quinn | `agent-department/Technical/quinn/MEMORY.md` |
...
| Task Keywords | Agent | Read This File |
|---|---|---|
| Copy, caption, content writing, brand voice, email, ad copy | ✍️ Lena | `agent-department/Marketing/lena/MEMORY.md` |
| Paid ads, Meta, TikTok, ROAS, CPM, funnel, conversion, retargeting | 📈 Rio | `agent-department/Marketing/rio/MEMORY.md` |
| Visual system, mood board, art direction, image prompt, brand visual identity, creative pipeline | 🎨 Atlas | `agent-department/Marketing/atlas/MEMORY.md` |
| Image batch, production pipeline, prompt optimisation, upscaling, asset delivery | ⚡ Pixel | `agent-department/Marketing/pixel/MEMORY.md` |
| Analytics, metrics, GA4, trend, data, KPI, insight, competitor, rival brand, market gap, YVON Health Score | 📊 Kai | `agent-department/Marketing/kai/MEMORY.md` |
| Growth, funnel, experiment, A/B, channel performance, opportunity | 🚀 Nate | `agent-department/Marketing/nate/MEMORY.md` |
| Finance, budget, P&L, revenue, CAC, LTV, MRR, margin, ROI, runway | 💰 Felix | `agent-department/Finance/felix/MEMORY.md` |
...
**Rule:** Edit shared skills in `agent-department/shared/` only.
