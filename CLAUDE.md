...
- `.toon/agents/[Dept]/[agent]/MEMORY.md` — when assigned by Marcus (agent switch Rule 1)
...
|---|---|---|
| Executive summary, CEO brief, priorities, OKRs, business direction, synthesis, strategy, War Room | 👑 Marcus | `.toon/agents/CEO/marcus/MEMORY.md` |
| Operations, workflow, process, project plan, milestones, sprint planning, dependencies | ⚙️ Diana | `.toon/agents/COO/diana/MEMORY.md` |

### Layer 2 — BUILD (Everything That Ships)

| Task Keywords | Agent | Read This File |
|---|---|---|
| Next.js, API routes, architecture, tech decision, build error, TypeScript, Vercel, deployment | 💻 Dev | `.toon/agents/Technical/dev/MEMORY.md` |
| Supabase, database, query, backend API, data model, route.ts, schema, migration | 🔧 Raj | `.toon/agents/Technical/raj/MEMORY.md` |
| React component, UI, Tailwind, layout, CSS, design system, wireframe, UX, screen design, visual design | 🎨 Mia | `.toon/agents/Technical/mia/MEMORY.md` |
| Testing, bug, QA review, lint, build check, edge case, verification, code quality, Pulse | 🧪 Quinn | `.toon/agents/Technical/quinn/MEMORY.md` |

### Layer 0 — PSYCHOLOGY (Behavioral Validation — cross-department)

| Task Keywords | Agent | Read This File |
|---|---|---|
| Cognitive bias, framing check, System 1 filter, psychological audit, decision review, loss aversion, anchoring, overconfidence, A/B interpretation, lever selection, debiasing, calibration | 🧠 Kahneman | `.toon/agents/Psychology/Daniel_Kahneman/MEMORY.md` |
...
| Task Keywords | Agent | Read This File |
|---|---|---|
| Copy, caption, content writing, brand voice, email, ad copy | ✍️ Lena | `.toon/agents/Marketing/lena/MEMORY.md` |
| Paid ads, Meta, TikTok, ROAS, CPM, funnel, conversion, retargeting | 📈 Rio | `.toon/agents/Marketing/rio/MEMORY.md` |
| Visual system, mood board, art direction, image prompt, brand visual identity, creative pipeline | 🎨 Atlas | `.toon/agents/Marketing/atlas/MEMORY.md` |
| Image batch, production pipeline, prompt optimisation, upscaling, asset delivery | ⚡ Pixel | `.toon/agents/Marketing/pixel/MEMORY.md` |
| Analytics, metrics, GA4, trend, data, KPI, insight, competitor, rival brand, market gap, YVON Health Score | 📊 Kai | `.toon/agents/Marketing/kai/MEMORY.md` |
| Growth, funnel, experiment, A/B, channel performance, opportunity | 🚀 Nate | `.toon/agents/Marketing/nate/MEMORY.md` |
| Finance, budget, P&L, revenue, CAC, LTV, MRR, margin, ROI, runway | 💰 Felix | `.toon/agents/Finance/felix/MEMORY.md` |
...
| Full agent registry (13 agents, 4 departments) | `.toon/agents/DEPARTMENTS.md` |
...
For department overview: read `.toon/agents/DEPARTMENTS.md`
...
All agents share critical skills from `.toon/agents/shared/`:
- `skills/agents/01-memory.md` — Memory system rules
- `skills/coding/01-karpathy.md` — Karpathy coding guidelines

**Rule:** Edit shared skills in `.toon/agents/shared/` only.
