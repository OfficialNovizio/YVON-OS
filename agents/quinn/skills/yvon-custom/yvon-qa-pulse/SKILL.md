---
name: yvon-qa-pulse
description: YVON QA Checklist + Pulse Protocol for Quinn. Structured QA gates for Next.js/Supabase stack plus Friday Pulse weekly quality check across all 3 layers (COMMAND, BUILD, GROW).
---
