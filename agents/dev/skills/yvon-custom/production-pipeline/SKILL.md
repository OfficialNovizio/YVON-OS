...
description: YVON Production Pipeline for Pixel. 5-stage pipeline: Generate plus QC plus Upscale plus Format plus Deliver. Batch management, platform export specs, and rejection handling.
---
