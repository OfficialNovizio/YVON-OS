...
async function loadOsContext(ventureSlug?: string): Promise<OsContext> {
  ...
  const [
    ...
    ventureSlug && ventureSlug !== 'yvon-dashboard'
      ...
      : Promise.resolve(''),
    safeRead(path.join(root, '.toon/agents/shared/skills/coding/01-karpathy.md'), 3000),
    safeRead(path.join(root, '.toon/agents/shared/skills/agents/01-memory.md'), 2000),
    safeRead(path.join(root, '.toon/agents/shared/skills/operating-system/session-protocol/SKILL.md'), 2000),
    safeRead(path.join(root, '.toon/agents/shared/skills/operating-system/reflection-protocol/SKILL.md'), 2000),
  ])
